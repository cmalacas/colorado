...
export default class Adjustable extends Component {
    ...
    add( data ) {
        ...
        Authservice.addAdjustable( data )
        .then( response => {

            if (response.adjustables) {        
                this.setState( { data: response.adjustables } );
            }         
    ...
    delete( data ) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {           
                Authservice.deleteAdjustable( { id: data.id }  )
                .then( response => {
                    if (response.adjustables) {        
                        this.setState( { data: response.adjustables } );
                    }         
    ...
    save( data ) {
        ...
        Authservice.saveAdjustable( data )
        .then( response => {
    ...
    getData( data ) {
        ...
        Authservice.getAdjustable( data )
        .then( response => {
            ...
            <Fragment>
                <div className="row page-titles">
                    <div className="col-md-5 align-self-center">
                        <h4 className="text-themecolor">Adjustable</h4>
                    </div>
                    <div className="col-md-7 align-self-center text-right">
                        <div className="d-flex justify-content-end align-items-center">
                            <ol className="breadcrumb">
                                <li className="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li className="breadcrumb-item active">Adjustable</li>
                            </ol>
