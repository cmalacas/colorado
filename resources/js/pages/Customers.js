...
export default class Customers extends Component {
    ...
    render() {
        ...
        const data = this.state.customers.map( (c,i) => {
            ...
            c.actions = <Fragment>
                            <Edit customer={ c } save={ this.update } />
                            <Contacts customer={ c } contacts={ contacts } update={ this.updateContact } save={ this.saveContact } />
...
class Edit extends Component {
    ...
    componentDidUpdate() {
        ...
        if ( this.state.id !== this.props.customer.id ) {
            ...
            this.setState( { id: this.props.customer.id, name: this.props.customer.name } );
