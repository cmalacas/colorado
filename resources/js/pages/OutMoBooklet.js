...
export default class OutMoBooklet extends Component {
    ...
    add( data ) {
        ...
        Authservice.addOutMoBooklet( data )
        .then( response => {

            if (response.booklets) {        
                this.setState( { data: response.booklets } );
            }         
    ...
    delete( data ) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {           
                Authservice.deleteOutMoBooklet( { id: data.id }  )
                .then( response => {
                    if (response.booklets) {        
                        this.setState( { data: response.booklets } );
                    }         
    ...
    save( data ) {
        ...
        Authservice.saveOutMoBooklet( data )
        .then( response => {
    ...
    getData( data ) {
        ...
        Authservice.getOutMoBooklet( data )
        .then( response => {
