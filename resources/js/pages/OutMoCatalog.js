...
export default class OutMoCatalog extends Component {
    ...
    add( data ) {
        ...
        Authservice.addOutMoCatalog( data )
        .then( response => {

            if (response.catalogs) {        
                this.setState( { data: response.catalogs } );
            }         
    ...
    delete( data ) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {           
                Authservice.deleteOutMoCatalog( { id: data.id }  )
                .then( response => {
                    if (response.catalogs) {        
                        this.setState( { data: response.catalogs } );
                    }         
    ...
    save( data ) {
        ...
        Authservice.saveOutMoCatalog( data )
        .then( response => {
    ...
    getData( data ) {
        ...
        Authservice.getOutMoCatalog( data )
        .then( response => {
            ...
            <Fragment>
                <div className="row page-titles">
                    <div className="col-md-5 align-self-center">
                        <h4 className="text-themecolor">Out Mo Catalog</h4>
                    </div>
                    <div className="col-md-7 align-self-center text-right">
                        <div className="d-flex justify-content-end align-items-center">
                            <ol className="breadcrumb">
                                <li className="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li className="breadcrumb-item active">Out Mo Catalog</li>
                            </ol>
