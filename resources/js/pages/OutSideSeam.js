...
export default class OutSideSeam extends Component {
    ...
    add( data ) {
        ...
        Authservice.addSideSeam( data )
        .then( response => {

            if (response.sides) {        
                this.setState( { data: response.sides } );
            }         
    ...
    delete( data ) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {           
                Authservice.deleteSideSeam( { id: data.id }  )
                .then( response => {
                    if (response.sides) {        
                        this.setState( { data: response.sides } );
                    }         
    ...
    render() {
        ...
        const outs = this.state.data.filter( d => { 
            ...
            console.log('search', die_size, search);
            ...
            } else if ( field === 'flat_size' && flat_size.indexOf( search ) >= 0 ) {
            ...
            <Fragment>
                <div className="row page-titles">
                    <div className="col-md-5 align-self-center">
                        <h4 className="text-themecolor">Side Seam</h4>
                    </div>
                    <div className="col-md-7 align-self-center text-right">
                        <div className="d-flex justify-content-end align-items-center">
                            <ol className="breadcrumb">
                                <li className="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li className="breadcrumb-item active">Side Seam</li>
                            </ol>
                                    ...
                                    <Col className="text-right d-flex justify-content-between">
                                        <FormGroup row className="mb-0">
                                            ...
                                            <Col sm={9} className="d-flex">
                                                <Input className="mr-2" type="text" onChange={ this.search } />
                                                <Input style={ { height: 'auto' } } type="select" onChange={ this.select }>
                                                    ...
                                                    <option value="flat_size">Flat Size</option>
                ...
                <Modal className="mw-100 w-50" isOpen={this.state.open} toggle={this.close}>
                    ...
                    <ModalBody>
                        ...
                        <FormGroup>
                            ...
                            <Input name="flat_size" value={this.state.flat_size} onChange={this.change} />
                        </FormGroup>
                        <FormGroup>
