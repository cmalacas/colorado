...
export default class StraightKnifeUnscheduled extends Component {
    ...
    getData( data ) {
        ...
        Authservice.getStraightKnifeUnscheduled( data )
        .then( response => {
    ...
    save( oldvalue, newvalue, row, column) {
        ...
        Authservice.saveStraightKnifeSchedule( row );
            ...
            <Fragment>
                ...
                <div className="row page-titles">
                    <div className="col-md-5 align-self-center">
                        <h4 className="text-themecolor">Straight Knife Unscheduled</h4>
                    </div>
                    <div className="col-md-7 align-self-center text-right">
                        <div className="d-flex justify-content-end align-items-center">
                            <ol className="breadcrumb">
                                <li className="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li className="breadcrumb-item active">Straight Knife Unscheduled</li>
                            </ol>
