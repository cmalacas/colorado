...
export default class WebRa extends Component {
    ...
    add( data ) {
        ...
        Authservice.addWebRA( data )
        .then( response => {

            if (response.webs) {        
                this.setState( { data: response.webs } );
            }         
    ...
    delete( data ) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {           
                Authservice.deleteWebRA( { id: data.id }  )
                .then( response => {
                    if (response.webs) {        
                        this.setState( { data: response.webs } );
                    }         
            ...
            <Fragment>
                <div className="row page-titles">
                    <div className="col-md-5 align-self-center">
                        <h4 className="text-themecolor">Web RA</h4>
                    </div>
                    <div className="col-md-7 align-self-center text-right">
                        <div className="d-flex justify-content-end align-items-center">
                            <ol className="breadcrumb">
                                <li className="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li className="breadcrumb-item active">Web RA</li>
                            </ol>
