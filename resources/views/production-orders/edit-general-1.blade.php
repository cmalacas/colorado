<div class="form-group row">
    ...
    {{-- <a data-toggle="tooltip" title="Select customer" href="#" class="btn btn-primary btn-customer"><i
...
<div class="form-group row">
    ...
    <label class="col-md-3 text-right">Sales Rep</label>

    <div class="col-md-7">

        <select tabindex="1" id="SalesRep" name="SalesRep" class="form-control">
            <option value="0">----</option>
            @foreach($salesreps as $rep)

                @if (isset($data['SalesRep']) && $data['SalesRep'] == $rep['name'])

                    <option selected="selected" value={{ $rep['name'] }}>{{ $rep['name'] }}</option>
    ...
    <div id="sales-rep-button">xxx</div>
