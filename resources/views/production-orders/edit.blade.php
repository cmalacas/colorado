    ...
    'value' => isset($data['id']) ? $data['id'] : 0
            ...
            <div class="col-md-3">
              ...
              <div class="buttons text-right p-2">
                ...
                <a data-toggle="tooltip" title="Create new production order" href="/production-orders/create"
                  class="btn btn-success"><i class="fa fa-plus"></i></a>

                <button data-toggle="tooltip" title="Save" data-action="save" class="btn btn-primary"><i
                    class="fa fa-save"></i></button>

                <button data-toggle="tooltip" title="Print" data-action="print" class="btn btn-info"><i
                    class="fa fa-print"></i></button>

                <button data-toggle="tooltip" title="Cancel" data-action="cancel" class="btn"><i
                    class="fa fa-reply"></i></button>

                <a data-toggle="tooltip" title="Duplicate this production order"
                  href="/production-orders/{{ $data->id }}/copy" class="btn btn-success"><i class="fa fa-copy"></i></a>

                <a data-toggle='tooltip' title="Advanced Search" href="#" class="btn btn-primary po-search-button"
                  title="Advanced Search"><i class="fa fa-search"></i></a>
          ...
          <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" id="converting-tab" data-toggle="tab" href="#converting" role="tab"
                aria-controls="converting" aria-selected="false">Converting</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="cutting-tab" data-toggle="tab" href="#cutting" role="tab" aria-controls="cutting"
                aria-selected="false">Cutting</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="printing-tab" data-toggle="tab" href="#printing" role="tab"
                aria-controls="printing" aria-selected="false">Printing</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="packaging-tab" data-toggle="tab" href="#packaging" role="tab"
                aria-controls="packaging" aria-selected="false">Packaging</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" id="packing-tab" data-toggle="tab" href="#packing" role="tab" aria-controls="packing"
                aria-selected="false">Packing Slip</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="related-tab" data-toggle="tab" href="#related" role="tab" aria-controls="related"
                aria-selected="false">Related Purchase Orders</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" id="documents-tab" data-toggle="tab" href="#documents" role="tab"
                aria-controls="related" aria-selected="false">Documents</a>
            </li>
            <!-- <li class="nav-item">
          ...
          <div class="text-right p-2">
            <button onClick="return javascript:productOrderForm.submit();"
...
<script>
  ...
  const salesreps = {!! $salesreps!!};

  $('select[name=CustomerId]').on('change', function (e) {

    let options = '<options value="">---</option>';

    const reps = salesreps.filter(s => s.customer_id == e.target.value);
    ...
    $('select[name=SalesRep]').html(options);
