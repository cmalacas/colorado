        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist"> 
                    ...
                    <li class="nav-item">
                        <a class="nav-link mr-1" id="sides-tab" data-toggle="tab" href="#sides" role="tab" aria-controls="related" aria-selected="false">Box Size</a>
                    </li>                    
                    <li class="nav-item">
                        <a class="nav-link mr-1" id="ctn-size-tab" data-toggle="tab" href="#ctn-size" role="tab" aria-controls="related" aria-selected="false">Ctn Size</a>
                    </li>                    
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="jet-stock-tab" data-toggle="tab" href="#jet-stock" role="tab" aria-controls="related" aria-selected="false">Jet Stock</a>
                    </li>                    
                </ul>
