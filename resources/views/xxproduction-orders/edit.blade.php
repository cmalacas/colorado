                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" style="display: flex; justify-content: flex-start">
                            ...
                            <select name="select" onChange="javascript:location.href=this.value" class="form-control">
                                <option value="0"></option>
                                @foreach($options as $option)
                                <option value="/production-orders/{{ $option }}/edit" @if($data->id == $option) selected @endif >{{ $option }}</option>
                                @endforeach
                            </select>
