<div style="display: flex">
    ...
    <div style="border: solid 2px #ff0000; padding:0; margin-bottom:10px; vertical-align:top; width:100%">
          ...
          <table style="width:100%">
            ...
            <tr>
              ...
              <td>
                ...
                <h2 style="text-align:center; font-size: 16px;">Routing:</h2>
        ...
        <div style="margin-left:10px; margin-top:10px; width:68%; display:inline-block;">
          ...
          <table style="width:100%">
            ...
            <tr>
              ...
              <td colspan="2"><h2 style="font-size:22px; white-space: nowrap; margin:0">Total Quantity: <strong>{{ $data['Total'] + 0 }}M</strong></h2></td>

              <td><h2 style="font-size: 22px; white-space: nowrap; margin: 0">RUN ALL: <strong>@if($data['RunAll'] == 1) Yes @endif</strong></h2></td>
      ...
      <div style="display:flex; justify-content: flex-start; border-top:solid 2px #ff0000">
          ...
          <div style="width:33%; padding-left: 10px; padding-top:10px; border-right: solid 2px #ff0000; min-height: 75px;">

              @if (!empty($data['SealFlap']))

              <p style="font-size: 12px; margin-bottom: 5px;">Seal Flap: <strong>{{ $data['SealFlap'] }}</strong></p>
              ...
              <p style="font-size: 12px; margin-bottom: 5px;">Type Of Gum: <strong>{{ $data['GumType'] }}</strong></p>
              ...
              <p style="font-size: 12px; margin-bottom: 5px;">Amount For Jets: <strong>{{ $data['AmountForJets'] }}</strong></p>
          ...
          <div style="width:33%; padding-left: 10px; padding-top: 10px;  border-right: solid 2px #ff0000">
            ...
            <p style="font-size: 12px; margin-bottom: 5px;">1.: <strong>{{ $data['WindowSz1'] }}</strong></p>

            @endif

            @if (!empty($data['WindowSz2']))

            <p style="font-size: 12px; margin-bottom: 5px;">2.: <strong>{{ $data['WindowSz2'] }}</strong></p>

            @endif

            @if (!empty($data['WindowSz3']))

            <p style="font-size: 12px; margin-bottom: 5px;">3.: <strong>{{ $data['WindowSz3'] }}</strong></p>

            @endif 

            @if (!empty($data['WindowDoubleDie']))

            <p style="font-size: 12px; margin-bottom: 5px;">Double Window <strong>{{ $data['WindowDoubleDie'] }}</strong></p>
          ...
          <div style="width:33%; padding-left: 10px; padding-top: 10px; ">
            ...
            <p style="font-size: 12px; margin-bottom: 5px;">1.: <strong><span style="display:inline-block; width: 200px;">{{ $data['WindowPos1'] }}</span> {{ $data['OpenPolyWinPos1'] }}</strong></p>

            @endif

            @if (!empty($data['WindowPos2']))

            <p style="font-size: 12px; margin-bottom: 5px;">2.: <strong><span style="display:inline-block; width: 200px;">{{ $data['WindowPos2'] }}</span> {{ $data['OpenPolyWinPos2'] }}</strong></p>

            @endif

            @if (!empty($data['WindowPos3']))

            <p style="font-size: 12px; margin-bottom: 5px;">3.: <strong><span style="display:inline-block; width: 200px;">{{ $data['WindowPos3'] }}</span> {{ $data['OpenPolyWinPos3'] }}</strong></p>
