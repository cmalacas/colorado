    ...
    <div style="border: solid 2px #cc6600; padding:0 10px; margin-bottom:10px; vertical-align:top; width:100%">
      ...
      <table width="100%" cellspacing=0 border=0>
        ...
        <tbody>
          ...
          <tr>
            <td style="font-size: 12px; padding:3px 0;">Out Diagonals</td>
          ...
          <tr>
            <td style="font-size: 12px; padding:3px 0;">Out MO Booklet</td>
          ...
          <tr>
            <td style="font-size: 12px; padding:3px 0;">Out MO Catalog</td>
