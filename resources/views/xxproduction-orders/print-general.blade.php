<div style="margin-bottom:10px; display:flex">
    ...
    <div class="section-details" style="border: solid 2px #000; padding: 5px; width:100%">
      ...
      <table style="width:100%">
          ...
          <tr>
            <td style="padding: 3px 0; font-size: 10px;">Sold To: <strong>{{ $data['customer']['name'] }}</strong></td>
          ...
          <tr>
            <td style="padding: 3px 0; font-size: 10px;" colspan="2">Customer PO: <strong>{{ $data['CustPO'] }}</strong></td>
        ...
        <tr>
          ...
          <td style="padding: 3px 0; font-size: 10px" colspan="4">Additional Changes: <strong>{{ $data['AdditionalChg'] }}</strong></td>
