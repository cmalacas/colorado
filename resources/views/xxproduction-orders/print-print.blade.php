...
@if ( !empty($data['Printing']) || !empty($data['Sides']) || !empty($data['InsideTintStyle']) || !empty($data['Colors1']) || !empty($data['Colors2']) || !empty($data['Colors3']) || !empty($data['CustomerSup']))
  ...
  <div style="border: solid 2px #336600; padding: 10px; width:48%; margin-right: 10px">
    ...
    <p style="font-size: 12px; margin-bottom: 5px;">Printing: <strong>{{ $data['Printing'] }}</strong></p>
    ...
    <p style="font-size: 12px; margin-bottom: 5px;">Sides: <strong>{{ $data['Sides'] }}</strong></p>

    @endif 

    @if (!empty($data['InsideTintStyle']))

    <p style="font-size: 12px; margin-bottom: 5px;">Inside Tint Style: <strong>{{ $data['InsideTintStyle'] }}</strong></p>

    @endif

    @if (!empty($data['Colors1']))
    <p style="font-size: 12px; margin-bottom: 5px;">Color 1: <strong>{{ $data['Colors1'] }}</strong></p>
    @endif

    @if (!empty($data['Colors2']))
    <p style="font-size: 12px; margin-bottom: 5px;">Color 2: <strong>{{ $data['Colors2'] }}</strong></p>
    @endif

    @if (!empty($data['Colors3']))
    <p style="font-size: 12px; margin-bottom: 5px;">Color 3: <strong>{{ $data['Colors3'] }}</strong></p>
    @endif

    @if (!empty($data['Colors4']))
    <p style="font-size: 12px; margin-bottom: 5px;">Color 4: <strong>{{ $data['Colors4'] }}</strong></p>
    @endif
